...
public interface ManageCustomerOrderInternal {
  ...
  public Boolean executeStep(
                      @WebParam( name = "processStepId", targetNamespace = "http://www.orangecaraibe.com/soa/v2/Interfaces/ManageCustomerOrderInternal" )
                      java.lang.Long processStepId,
                      @WebParam( name = "processStepDate", targetNamespace = "http://www.orangecaraibe.com/soa/v2/Interfaces/ManageCustomerOrderInternal" )
                      java.lang.String processStepDate)
