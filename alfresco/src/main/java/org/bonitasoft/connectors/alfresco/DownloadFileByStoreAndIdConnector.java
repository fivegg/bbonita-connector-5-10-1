 ...
 *
 */
public class DownloadFileByStoreAndIdConnector extends AlfrescoConnector {
	...
	protected void executeFunction(AlfrescoRestClient alfrescoClient) throws Exception {
		response = alfrescoClient.downloadFileByStoreAndId(store, fileId, outputFileFolder, outputFileName);
	}
