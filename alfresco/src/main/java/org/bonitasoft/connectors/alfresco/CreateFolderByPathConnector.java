...
public class CreateFolderByPathConnector extends AlfrescoConnector {
	...
	public void setNewFoldersDescription(String newFoldersDescription) {
		this.newFoldersDescription = newFoldersDescription;
	}
	...
	protected void executeFunction(AlfrescoRestClient alfrescoClient) throws Exception {
		response = alfrescoClient.createFolderByPath(parentPath, newFoldersName, newFoldersDescription);
	}
