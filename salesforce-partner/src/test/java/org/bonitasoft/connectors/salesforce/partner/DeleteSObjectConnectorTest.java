 ...
 * 
 */
public class DeleteSObjectConnectorTest extends SalesforceConnectorTest {
	...
	public void testDeleteAccount() throws Exception {
		...
		assertNull(retrieveConnector.getSObject());
	...
	public void testDeleteCustomObject() throws Exception {
	...
	protected Class<? extends Connector> getConnectorClass() {
		return DeleteSObjectConnector.class;
	}
  ...
  protected SalesforceConnector getSalesforceConnector() {
    DeleteSObjectConnector deleteSObjectConnector = new DeleteSObjectConnector();
    deleteSObjectConnector.setSObjectId("id_not_empty");
    return deleteSObjectConnector;
  }
}
