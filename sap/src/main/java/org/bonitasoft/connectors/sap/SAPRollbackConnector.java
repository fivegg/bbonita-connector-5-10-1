 ...
 *
 */
public class SAPRollbackConnector extends SAPUseConnectionAbstractConnector {

  @Override
  protected void executeConnector() throws Exception {
    final Client jcoClient = getJcoClient();
    final Repository jcoRepository = createRepository(jcoClient);
    final Function jcoFunction = createFunction(jcoRepository, SAPConstants.BAPI_TRANSACTION_ROLLBACK);
