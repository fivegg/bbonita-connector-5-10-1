...
public class BAPI_COMPANY_GETDETAIL {
  ...
  private static void callFunction(final String existingConnectionName) throws Exception {
    ...
    SAPUtil.callFunction(existingConnectionName, releaseClient, commitOnSuccess, rollbackOnFailure, printHtml, "BAPI_COMPANY_GETDETAIL", inputParameters, outputParameters);
  }
