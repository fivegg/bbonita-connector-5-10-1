...
public class BAPI_COMPANYCODE_GETLIST {
  ...
  private static void callFunction(final String existingConnectionName) throws Exception {
    ...
    SAPUtil.callFunction(existingConnectionName, releaseClient, commitOnSuccess, rollbackOnFailure, printHtml, "BAPI_COMPANYCODE_GETLIST", inputParameters, outputParameters);
  }
