...
public class Return_search_result  implements java.io.Serializable {
    private org.bonitasoft.connectors.sugar.common.soap.v2.Link_name_value[] entry_list;

    public Return_search_result() {
    }

    public Return_search_result(
           org.bonitasoft.connectors.sugar.common.soap.v2.Link_name_value[] entry_list) {
     ...
     * @return entry_list
     */
    public org.bonitasoft.connectors.sugar.common.soap.v2.Link_name_value[] getEntry_list() {
        return entry_list;
    }
     ...
     * @param entry_list
     */
    public void setEntry_list(org.bonitasoft.connectors.sugar.common.soap.v2.Link_name_value[] entry_list) {
        this.entry_list = entry_list;
    }
