...
public class Link_name_value  implements java.io.Serializable {
    ...
    private org.bonitasoft.connectors.sugar.common.soap.v2.Name_value[][] records;
    ...
    public Link_name_value(
           ...
           org.bonitasoft.connectors.sugar.common.soap.v2.Name_value[][] records) {
           this.name = name;
     ...
     * @return records
     */
    public org.bonitasoft.connectors.sugar.common.soap.v2.Name_value[][] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(org.bonitasoft.connectors.sugar.common.soap.v2.Name_value[][] records) {
        this.records = records;
    }
