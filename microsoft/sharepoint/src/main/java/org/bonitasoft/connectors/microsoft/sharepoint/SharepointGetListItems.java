 ...
 */
public class SharepointGetListItems extends ProcessConnector {
	...
	protected List<ConnectorError> validateValues() {
		...
		if (listName == null || listName.length() <= 0 ) {
			errors.add(new ConnectorError("listName", new IllegalArgumentException("cannot be empty!")));
		}
		return errors;
	}
	...
	protected void executeConnector() throws Exception {
        ...
        xmlResponse = client.getListItems(listPort, listName);
	}
	...
	/**
	 * Setter for input argument 'listName'
	 */
	...
	/**
	 * Getter for output argument 'xmlResponse'
	 */
