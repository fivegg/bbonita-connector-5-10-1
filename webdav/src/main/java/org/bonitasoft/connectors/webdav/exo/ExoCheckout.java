 ...
 * 
 */
public class ExoCheckout extends ExoConnector {
    ...
    /**
     * check out the URI specified file, so it can be modified.
     * 
     * @param uri
     * @throws Exception
     */
    public void checkout(final String uri) throws Exception {

        if (LOGGER.isLoggable(Level.INFO)) {
            LOGGER.info("checkout '" + uri + "'");
        }

        final CheckoutMethod httpMethod = new CheckoutMethod(uri);
