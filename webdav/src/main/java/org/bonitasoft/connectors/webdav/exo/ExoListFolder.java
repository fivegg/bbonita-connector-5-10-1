 ...
 * 
 */
public class ExoListFolder extends ExoConnector {
     ...
     * set the uri
     * 
     * @param uri the URI of the folder to be listed
     */
    ...
    /**
     * list sub folders and files for the URI specified folder.
     * 
     * @param uri
     * @throws Exception
     */
    public void listFolder(final String uri) throws Exception {
