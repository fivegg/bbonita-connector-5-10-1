 ...
 *
 */
public class RetrieveDocumentsTest extends TestCase {

  public void testRetrieveDocuments() throws Exception{
    final RetrieveDocuments retrieveDocuments = new RetrieveDocuments();
    CMISConnectorUtil.configConnector(retrieveDocuments);
    final Map<String, String> conditions = new HashMap<String, String>();
    conditions.put("name", "Bonita-upload");
    retrieveDocuments.setConditions(conditions);
